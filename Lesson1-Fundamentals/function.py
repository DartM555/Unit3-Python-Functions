...
def calculate_engagement(likes, shares, comments):
    """Calcuate the total media engagement
    This function takes the number of likes, shares, and comments on a post and returns the total engamement count.
    
    Args:
        likes (int): The number of likes
        shares (int): The number of shares
        comments (int): The number of commments
        
        Returns:
        int: The total engagement, calculated as the sun of likes, shares, 
        and comments
        Example: >>> calculate_engamement(120, 45, 30)
        195
    """
